 ...
 *
 */
define("slate/transition/1.0.0/transition-debug", [ "$-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    $.fn.transition = function() {
        ...
        $allModules.each(function() {
            ...
            settings, instance, error, className, metadata, animationEnd, animationName, namespace, moduleNamespace, module;
            module = {
                initialize: function() {
                    // get settings
                ...
                get: {
                    ...
                    animationName: function() {
                        var element = document.createElement("div"), animations = {
                ...
                can: {
                    ...
                    transition: function() {
                        var elementClass = $module.attr("class"), animation = settings.animation, transitionExists = module.get.transitionExists(settings.animation), $clone, currentAnimation, inAnimation, displayType;
