/*
 * # SlateUI extend Semantic - Sidebar
 ...
 *
 */
define("slate/sidebar/1.0.0/sidebar-debug", [ "$-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    $.fn.sidebar = function(parameters) {
        var $allModules = $(this), $body = $("body"), $head = $("head"), moduleSelector = $allModules.selector || "", time = new Date().getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == "string", queryArguments = [].slice.call(arguments, 1), returnedValue;
        $allModules.each(function() {
            ...
            module = {
                ...
                pushPage: function() {
                    var direction = module.get.direction(), distance = module.is.vertical() ? $module.outerHeight() : $module.outerWidth();
                    if (settings.useCSS) {
