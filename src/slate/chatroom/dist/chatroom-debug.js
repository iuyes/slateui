 ...
 *
 */
define("slate/chatroom/1.0.0/chatroom-debug", [ "$-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
        ...
        $(this).each(function() {
            ...
            module = {
                ...
                event: {
                    ...
                    submit: function() {
                        var message = $messageInput.val(), loggedInUser = $module.data("user");
