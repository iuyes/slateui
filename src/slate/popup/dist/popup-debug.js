        ...
        $allModules.each(function() {
            ...
            module = {
                ...
                create: function() {
                    ...
                    var html = $module.data(metadata.html) || settings.html, variation = $module.data(metadata.variation) || settings.variation, title = $module.data(metadata.title) || settings.title, content = $module.data(metadata.content) || $module.attr("title") || settings.content;
                    if (html || content || title) {
                        ...
                        if (settings.inline) {
                            ...
                            $popup.data(moduleNamespace, instance).insertAfter($module);
                        } else {
                ...
                animate: {
                    show: function(callback) {
                        ...
                        if (settings.transition && $.fn.transition !== undefined && $module.transition("is supported")) {
                            $popup.transition(settings.transition + " in", settings.duration, function() {
                                module.bind.close();
                    ...
                    hide: function(callback) {
                        ...
                        if (settings.transition && $.fn.transition !== undefined && $module.transition("is supported")) {
                            $popup.transition(settings.transition + " out", settings.duration, function() {
                                module.reset();
                                callback();
                            });
                        } else {
                ...
                set: {
                    position: function(position, arrowOffset) {
                        var windowWidth = $(window).width(), windowHeight = $(window).height(), width = $target.outerWidth(), height = $target.outerHeight(), popupWidth = $popup.width(), popupHeight = $popup.outerHeight(), parentWidth = $offsetParent.outerWidth(), parentHeight = $offsetParent.outerHeight(), distanceAway = settings.distanceAway, offset = settings.inline ? $target.position() : $target.offset(), positioning, offstagePosition;
