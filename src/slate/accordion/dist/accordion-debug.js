/*
 * # SlateUI extend Semantic - Accordion
 ...
 *
 */
define("slate/accordion/1.0.0/accordion-debug", [ "$-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
        ...
        $allModules.each(function() {
            ...
            module = {
                ...
                toggle: function(index) {
                    ...
                    var $activeTitle = $title.eq(index), $activeContent = $activeTitle.next($content), contentIsOpen = $activeContent.is(":visible");
                    if (contentIsOpen) {
                ...
                open: function(index) {
                    var $activeTitle = $title.eq(index), $activeContent = $activeTitle.next($content), $previousTitle = $activeTitle.siblings(selector.title).filter("." + className.active), $previousContent = $previousTitle.next($title), contentIsOpen = $previousTitle.size() > 0;
