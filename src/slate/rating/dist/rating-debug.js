/*
 * # SlateUI extend Semantic - Rating
 ...
 *
 */
define("slate/rating/1.0.0/rating-debug", [ "$-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
        ...
        $allModules.each(function() {
            ...
            module = {
                ...
                event: {
                    ...
                    click: function() {
                        var $activeIcon = $(this), currentRating = module.getRating(), rating = $icon.index($activeIcon) + 1;
