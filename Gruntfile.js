module.exports = function (grunt) {
    ...
    // debug #feeloc#
        ...
        onlineTasks = releaseTasks.concat(copyToStaticsTask), //online #feeloc#
        debugTasks = releaseTasks.concat(copyToDebugTask), //debug #feeloc#
    ...
    config = {
        ...
        shell: {
            ...
            multiple: {
                command: [
                    ...
                    'git remote add origin git@github.com:feeloc/slateui.git',
        ...
        copy: {
            ...
            // copy bulid files to statics #feeloc#
            buildToStatics: {
                files: [
                    {
                        src: 'build/packaged/css/semantic.min.css',
                        dest: '../statics/css/ui.css'
                    },
                    {
                        src: 'build/packaged/css/semantic.css',
                        dest: '../statics/css/ui-debug.css'
                    },
                    {
                        src: 'build/packaged/javascript/semantic.min.js',
                        dest: '../statics/js/ui.js'
                    },
                    {
                        src: 'build/packaged/javascript/semantic.js',
                        dest: '../statics/js/ui-debug.js'
                    },
                    {
                        expand: true,
                        cwd: 'build/packaged/',
    ...
    grunt.registerTask('online', onlineTasks);  // online, build to statics #feeloc#
    grunt.registerTask('debug', debugTasks);  // online, build to statics #feeloc#
