 ...
 *
 */
define("slate/shape/1.0.0/shape-debug", [ "$-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    $.fn.shape = function(parameters) {
        var $allModules = $(this), $body = $("body"), time = new Date().getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == "string", queryArguments = [].slice.call(arguments, 1), returnedValue;
        $allModules.each(function() {
            var moduleSelector = $allModules.selector || "", settings = $.extend(true, {}, $.fn.shape.settings, parameters), // internal aliases
            ...
            nextSelector = false, $activeSide, $nextSide, // standard module
            ...
            module = {
                ...
                repaint: function() {
                    ...
                    var shape = $sides.get(0) || document.createElement("div"), fakeAssignment = shape.offsetWidth;
                },
                ...
                set: {
                    ...
                    stageSize: function() {
                        var $clone = $module.clone().addClass(className.loading), $activeSide = $clone.find("." + settings.className.active), $nextSide = nextSelector ? $clone.find(nextSelector) : $activeSide.next(selector.side).size() > 0 ? $activeSide.next(selector.side) : $clone.find(selector.side).first(), newSize = {};
                ...
                get: {
                    ...
                    transitionEvent: function() {
                        var element = document.createElement("element"), transitions = {
