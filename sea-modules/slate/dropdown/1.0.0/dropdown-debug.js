/*
 * # SlateUI extend Semantic - Dropdown
 ...
 *
 */
define("slate/dropdown/1.0.0/dropdown-debug", [ "$-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
            ...
            module = {
                ...
                event: {
                    ...
                    item: {
                        mouseenter: function(event) {
                            var $currentMenu = $(this).find(selector.submenu), $otherMenus = $(this).siblings(selector.item).children(selector.menu);
                        ...
                        click: function(event) {
                            var $choice = $(this), text = $choice.data(metadata.text) !== undefined ? $choice.data(metadata.text) : $choice.text(), value = $choice.data(metadata.value) !== undefined ? $choice.data(metadata.value) : typeof text === "string" ? text.toLowerCase() : text, callback = function() {
                ...
                get: {
                    ...
                    item: function(value, strict) {
                        ...
                        if (value !== undefined) {
                            $item.each(function() {
                                var $choice = $(this), optionText = $choice.data(metadata.text) !== undefined ? $choice.data(metadata.text) : $choice.text(), optionValue = $choice.data(metadata.value) !== undefined ? $choice.data(metadata.value) : typeof optionText === "string" ? optionText.toLowerCase() : optionText;
                                if (strict) {
                ...
                set: {
                    ...
                    selected: function(value) {
                        var $selectedItem = module.get.item(value), selectedText;
                        if ($selectedItem) {
                ...
                is: {
                    ...
                    animated: function($subMenu) {
                        return $subMenu ? $subMenu.is(":animated") || $subMenu.transition("is animating") : $menu.is(":animated") || $menu.transition("is animating");
                    },
